...
const gallery = [
  { src: "/class2.jpg", alt: "Primary classroom" },
  { src: "/class.jpg", alt: "Students learning" },
  { src: "/students2.jpg", alt: "Student activities" },
  { src: "/students3.jpg", alt: "Lower primary students" },
];

export default function LowerPrimary() {
  return (
    <>
      <Breadcrumbs crumbs={[{ label: "Programs", href: "/programmes" }, { label: "Lower Primary" }]} />
      ...
      <section className="bg-white py-16 sm:py-20">
        <Container>
          <div className="gap-14 lg:grid lg:grid-cols-[1fr_260px]">
            ...
            <ProgramSidebar currentSlug="lower-primary" />
          </div>
        </Container>
      </section>
